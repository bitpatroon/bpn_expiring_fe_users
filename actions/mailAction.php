...
//                $lang = $GLOBALS['LANG'];
//                $extendLink = '<a href="' . $url . '">' . htmlspecialchars($lang->sL('LLL:EXT:bpn_expiring_fe_users/Resources/Private/Language/locallang_db.xlf/locallang_db.xlf:mailAction.extendby')) . '</a>';
...
//    )
//    {
//        $expGrFields = self::getExpiringGroupsArray($user['tx_expiringfegroups_groups']);
//
