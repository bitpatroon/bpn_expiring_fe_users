...
/**
 * Class tx_bpnexpiringfeusers_scheduler
 * @original: tx_bpnexpiringfeusers_scheduler
 * @new     : SPL\
 * @orgpath :
 * @deprecated can be removed!
 */
class tx_bpnexpiringfeusers_scheduler extends \TYPO3\CMS\Scheduler\Task\AbstractTask
{
