...
final class DeleteActionService extends AbstractActionService
{
    protected $action = 'deleted';

    protected function executeSingle(Config $config, array $user, int $userId) : bool
    {
        $this->frontEndUserRepository->deleteUser($userId);
    ...
    {
        if ($result) {
            return 'user has been marked deleted.';
        }

        return 'Failed to mark user deleted';
    }
}
